...
* Use ``--mem`` to define how much memory is needed per node. By default you will be assigned 32GB of memory per allocated core. Please do not request more than what is needed for the job to run.
